# Generated by Django 5.2.7 on 2025-11-30 17:50
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('manage_users', '0007_departement_chef_departement'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'ordering': ['-datetime'],
                'indexes': [models.Index(fields=['employe', 'date'], name='manage_user_employe_3e4acc_idx'), models.Index(fields=['date'], name='manage_user_date_371956_idx')],
            },
        ),
        migrations.CreateModel(
            name='Presence',
            ...
            options={
                'ordering': ['-date'],
                'indexes': [models.Index(fields=['employe', 'date'], name='manage_user_employe_111ba5_idx'), models.Index(fields=['date', 'statut'], name='manage_user_date_77b359_idx')],

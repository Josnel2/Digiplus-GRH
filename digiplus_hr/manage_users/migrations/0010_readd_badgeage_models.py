# Generated manually: reintroduce QR code, badgeage, presence, rapport models
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('manage_users', '0009_remove_codeqr_employe_alter_presence_unique_together_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('statut', models.CharField(choices=[('present', 'Present'), ('absent', 'Absent'), ('retard', 'En retard'), ('conge', 'Conge'), ('repos', 'Jour de repos')], default='absent', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('arrivee', 'Arrivee'), ('depart', 'Depart'), ('pause_debut', 'Debut de pause'), ('pause_fin', 'Fin de pause')], max_length=20)),
        ...
        migrations.AddIndex(
            model_name='badgeage',
            index=models.Index(fields=['employe', 'date'], name='manage_user_employe_date_badge_idx'),
        ),
        migrations.AddIndex(
            model_name='badgeage',
